...
class InstagramReelService:
    ...
    def _parse_transcript(
        ...
        prompt = f"""You are a fitness expert who extracts structured workout information from Instagram Reel transcripts.
...
5. Any workout structure (supersets, circuits, HIIT, etc.)
6. Approximate timestamp in the video where each exercise is discussed{duration_context}

Transcript from Instagram Reel titled "{title}":
---
{transcript}
---
...
- Group related exercises if described as supersets or circuits
